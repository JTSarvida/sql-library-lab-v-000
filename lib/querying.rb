...
def select_character_names_and_number_of_books_they_are_in
  "SELECT characters.name, COUNT(*) as number_of_books FROM character_books JOIN characters ON character_books.charactyer_id = characters.id GROUP BY characters.name ORDER BY number_of_books DESC"
end
